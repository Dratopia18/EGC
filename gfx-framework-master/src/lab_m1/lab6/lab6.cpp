...
void Lab6::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix)
{
    ...
    int ModelShaderLocation = glGetUniformLocation(shader->program, "Model");

    // TODO(student): Set shader uniform "Model" to modelMatrix
    glUniformMatrix4fv(ModelShaderLocation, 1, GL_FALSE, glm::value_ptr(modelMatrix));

    // TODO(student): Get shader location for uniform mat4 "View"
    int ViewShaderLocation = glGetUniformLocation(shader->program, "View");
    ...
    int ProjectionShaderLocation = glGetUniformLocation(shader->program, "Projection");
    ...
    int TimeShaderLocation = glGetUniformLocation(shader->program, "uTime");
    glUniform1f(TimeShaderLocation, elapsedTime);
