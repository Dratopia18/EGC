...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1.0f);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            forward = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1.0f);
            forward = glm::normalize(forward);

            right = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1.0f);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 1.0f);
            right = glm::normalize(right);

            up = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(up, 1.0f);
            up = glm::normalize(up);
        }
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            glm::vec4 newPosition = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(position - target, 1.0f);
            position = target + glm::vec3(newPosition);
        ...
        void RotateThirdPerson_OY(float angle)
        {
            ...
            glm::vec3 target = GetTargetPosition();
            glm::vec4 newPosition = glm::rotate(glm::mat4(1.0f), angle, up) * glm::vec4(position - target, 1.0f);
            position = target + glm::vec3(newPosition);
        ...
        void RotateThirdPerson_OZ(float angle)
        {
            ...
            glm::vec3 target = GetTargetPosition();
            glm::vec4 newPosition = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(position - target, 1.0f);
            position = target + glm::vec3(newPosition);
